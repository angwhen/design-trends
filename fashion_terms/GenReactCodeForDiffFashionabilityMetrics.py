...
nytimes_term_to_normalized_deg_dict = pickle.load(open("%s/data/my_data/nytimes_term_to_normalized_deg_dict.p"%FASHION_DATA_PATH,"rb")) #diff than what is normally referred to as normalized deg centrality
