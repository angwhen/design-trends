...
class ColorThief(object):
    ...
    def get_palette(self, color_count=10, quality=10):
        ...
        """
        """image = self.image.convert('RGBA') #do not use whole image so no need for this, tho not using quality here
        ...
        cmap = MMCQ.quantize(self.pixels, color_count)
        return cmap.palette
